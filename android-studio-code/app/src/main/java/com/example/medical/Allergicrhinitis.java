...
public class Allergicrhinitis extends Activity {

    ImageButton home, community, hospital, ppage;
    Button otorhinolaryngology, allergy;
    public void onCreate(Bundle savedinstanceState){
        super.onCreate(savedinstanceState);
        setContentView(R.layout.allergicrhinitis);
        ...
        hospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    // 카카오맵 어플이 없는 경우
                    Toast.makeText(Allergicrhinitis.this, "카카오맵 어플을 설치해주세요.", Toast.LENGTH_SHORT).show();
