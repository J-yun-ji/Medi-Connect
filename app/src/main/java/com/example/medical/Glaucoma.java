        ...
        hospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    // 카카오맵 어플이 없는 경우
                    Toast.makeText(
                            Glaucoma.this, "카카오맵 어플을 설치해주세요.", Toast.LENGTH_SHORT).show();
        ...
        ophthalmology.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                try {
                    ...
                    // 카카오맵 어플이 없는 경우
                    Toast.makeText(Glaucoma.this, "카카오맵 어플을 설치해주세요.", Toast.LENGTH_SHORT).show();
                    // 카카오맵 어플을 다운로드 받을 수 있는 페이지 url
                    String marketUrl = "market://details?id=net.daum.android.map";
                    // 해당 url을 실행시키기 위한 intent 생성
                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(marketUrl));
